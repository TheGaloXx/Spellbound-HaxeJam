...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Spellbound", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Spellbound", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Spellbound";
		app.meta["name"] = "Spellbound";
